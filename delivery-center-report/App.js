    ...
    showTable : function() {
        ...
        this.grid = Ext.create('Rally.ui.grid.Grid', {
            ...
            columnCfgs: [
                ...
                { text : "Completed<br/>(count)",    dataIndex : "completedCount",   align : "center"}, 
                { text : "Accepted<br/>(count)",     dataIndex : "acceptedCount",    align : "center"}, 
                { text : "Story Points",   dataIndex : "totalPoints",      align : "center"}, 
                { text : "Target<br>Velocity",dataIndex : "plannedVelocity",  align : "center"},
                { text : "Accepted<br/>Points",dataIndex : "accepted",  align : "center"}, 
                { text : "Velocity (%)",       dataIndex : "velocity",         align : "center", renderer: this.renderVelocity }, 
                { text : "Velocity <br/>Utilization (%)",dataIndex : "velocityUtilization",  align : "center"}, 
